...
c.colors.messages.warning.bg = EXTCOLOR
c.colors.messages.warning.border = EXTCOLOR
...
c.colors.tabs.indicator.stop = EXTCOLOR
...
c.colors.tabs.pinned.even.bg = ACCENT2
c.colors.tabs.pinned.even.fg = BGCOLOR
c.colors.tabs.pinned.odd.bg = ACCENT2
